  ...
  return (
    <>
      ...
      >
        ...
        {checkPermissions('referensi.jenis_kk_lead_spip.edit') && (
          <MenuItem
            component={Link}
            href={'/referensi/jenis-kk-lead-spip/edit/' + props.item.pid}
        ...
        {checkPermissions('referensi.jenis_kk_lead_spip.delete') && (
